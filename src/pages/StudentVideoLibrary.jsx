        ...
        <div className="w-full max-w-md mb-4">
          <div className="flex bg-[rgba(255,255,255,0.05)] border border-white/10 rounded-full p-1">
            <button
              ...
              className={`flex-1 px-6 py-3 text-sm rounded-full transition-all duration-200 ${activeTab === 'mes-videos'
            ...
            <button
              ...
              className={`flex-1 px-6 py-3 text-sm rounded-full transition-all duration-200 ${activeTab === 'ressource'
                ? 'bg-[#e87c3e] text-white shadow-lg font-normal'
                : 'text-white/50 hover:text-white font-light'
                }`}
            >
                    ...
                    >
                      ...
                      >
                        <div className="flex items-center gap-3 flex-1 min-w-0 overflow-hidden">
                          <ChevronRight
                            size={20}
                            className={`text-white/50 transition-transform flex-shrink-0 ${selectedFolder === folder.id ? 'rotate-90' : ''
                              }`}
                          />
                          <div className="min-w-0 flex-1">
                            <h3 className="text-white font-light text-sm sm:text-base flex items-center gap-2 flex-wrap">
