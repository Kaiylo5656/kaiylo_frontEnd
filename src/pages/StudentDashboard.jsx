...
import { ExerciseSummaryPreview } from '../components/ExerciseSummaryPreview';
...
const StudentDashboard = () => {
  ...
  // Show execution view if a session is being executed — même fond que l’accueil (copie du bloc ci‑dessous, sans toucher au planning)
            ...
            >
              {selectedAssignments.length > 0 ? (
                selectedAssignments.length > 1 ? (
                  ...
                  <div className="space-y-4 w-full max-w-xl md:max-w-2xl lg:max-w-3xl mx-auto px-2 md:px-4 flex-1 flex flex-col">
                    {selectedAssignments.map((assignment, index) => (
