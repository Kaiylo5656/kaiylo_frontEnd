...
const SwitchToDraftModal = ({ 
  ...
  const modalId = 'switch-to-draft-modal';
  ...
  return (
    <BaseModal
      ...
      size="md"
      title="Passer en mode brouillon"
    ...
    >
      <div className="space-y-6">
        ...
        <div className="flex flex-col items-start space-y-4">
          <div className="text-left space-y-2">
            <p className="text-sm font-extralight text-white/70">
              Êtes-vous sûr de vouloir passer {sessionTitle ? (
                <>la séance <span className="font-normal text-white">"{sessionTitle}"</span> en mode brouillon ?</>
              ) : (
                <>cette séance en mode brouillon ?</>
              )}
            </p>
        ...
        <div className="flex justify-end gap-3 pt-0">
          ...
          >
            {loading ? 'Changement...' : 'Passer en brouillon'}
          </button>
        </div>
      </div>
    </BaseModal>
...
export default SwitchToDraftModal;
