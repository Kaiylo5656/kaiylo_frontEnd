...
const VoirPlusArrowIcon = ({ className }) => (
  ...
  useEffect(() => {
    const handleClickOutside = (event) => {
      if (
        ...
        (!globalCommentMobileRef.current || !globalCommentMobileRef.current.contains(event.target)) &&
        (!globalCommentDesktopRef.current || !globalCommentDesktopRef.current.contains(event.target))
      ) {
    ...
    >
      ...
      >
        ...
        <div className="md:hidden shrink-0 px-4 pt-3 pb-4 space-y-3 border-b border-white/10" style={isMobile ? undefined : { backgroundColor: 'rgba(0, 0, 0, 0.5)' }}>
          ...
          {videoType === 'student' && (
            <div className="md:hidden min-w-0" ref={globalCommentMobileRef}>
              <h4 className="text-sm font-normal mb-2" style={{ color: 'var(--kaiylo-primary-hex)' }}>
                Commentaire élève (global)
              </h4>
              <div className="relative">
                <div
                  className={`relative overflow-hidden rounded-[10px] p-3 bg-gradient-to-br from-[rgba(212,132,90,0.14)] to-[rgba(212,132,90,0.05)] [-webkit-tap-highlight-color:transparent]${sessionGlobalComment && sessionGlobalNeedsExpand
                      ? ' cursor-pointer hover:from-[rgba(212,132,90,0.165)] hover:to-[rgba(212,132,90,0.065)] focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--kaiylo-primary-hex)]/40 focus-visible:ring-offset-0 focus-visible:ring-offset-transparent'
                      : ''
                    }`}
                  role={sessionGlobalComment && sessionGlobalNeedsExpand ? 'button' : undefined}
                  tabIndex={sessionGlobalComment && sessionGlobalNeedsExpand ? 0 : undefined}
                  onClick={
                    sessionGlobalComment && sessionGlobalNeedsExpand
                      ? () => setSessionGlobalExpanded(true)
                      : undefined
                  }
                  onKeyDown={
                    sessionGlobalComment && sessionGlobalNeedsExpand
                ...
                >
                  {sessionGlobalComment ? (
                    <>
                      <p
                        className={`text-white/90 text-sm font-light leading-relaxed break-words whitespace-pre-wrap transition-none ${sessionGlobalNeedsExpand
                            ? 'pr-[4.75rem] pb-0 [mask-image:linear-gradient(to_bottom,#000_0%,#000_52%,rgb(0_0_0/0.88)_74%,rgb(0_0_0/0.4)_92%,transparent_100%)] [-webkit-mask-image:linear-gradient(to_bottom,#000_0%,#000_52%,rgb(0_0_0/0.88)_74%,rgb(0_0_0/0.4)_92%,transparent_100%)]'
                            : ''
                          }`}
                      >
                      ...
                      {sessionGlobalNeedsExpand && (
                        <span
                          className="absolute bottom-3 right-4 z-10 inline-flex items-center gap-1 text-sm font-normal pointer-events-none select-none"
                          style={{ color: 'var(--kaiylo-primary-hex)' }}
                          aria-hidden="true"
                        >
                          Voir plus
                          <VoirPlusArrowIcon className="h-[0.8em] w-[0.8em] shrink-0" />
                        </span>
                      )}
                    </>
                  ) : (
                ...
                {/* Popover version for expanded state */}
                {sessionGlobalExpanded && sessionGlobalNeedsExpand && sessionGlobalComment && (
                  <div
                    className="absolute top-0 left-0 w-full z-50 rounded-[10px] p-3 shadow-[0_8px_30px_rgb(0,0,0,0.6)] backdrop-blur-md bg-black/50 bg-gradient-to-br from-[rgba(212,132,90,0.14)] to-[rgba(212,132,90,0.05)] max-h-[300px] overflow-y-auto"
                  >
                    <p className="text-white/90 text-sm font-light leading-relaxed break-words whitespace-pre-wrap pb-7">
                      {sessionGlobalComment}
                    </p>
                    <span
                      className="absolute bottom-3 right-4 z-10 inline-flex items-center gap-1 text-sm font-normal cursor-pointer select-none hover:opacity-80 transition-opacity"
                      style={{ color: 'var(--kaiylo-primary-hex)' }}
                      onClick={(e) => {
                        e.stopPropagation();
                        setSessionGlobalExpanded(false);
        ...
        >
          <div className="flex flex-col flex-1 min-h-0">
            ...
            <div className="px-4 md:px-6 py-4 md:py-4 flex-1 flex flex-col min-h-0">
              {videoType === 'student' && (
                <div className="hidden md:block mb-4 md:mb-5 min-w-0" ref={globalCommentDesktopRef}>
                  <h4 className="text-sm font-normal mb-2" style={{ color: 'var(--kaiylo-primary-hex)' }}>
                    Commentaire élève (global)
                  </h4>
                  <div className="relative">
                    <div
                      className={`relative overflow-hidden rounded-[10px] p-3 md:p-4 bg-gradient-to-br from-[rgba(212,132,90,0.14)] to-[rgba(212,132,90,0.05)] [-webkit-tap-highlight-color:transparent]${sessionGlobalComment && sessionGlobalNeedsExpand
                          ? ' cursor-pointer hover:from-[rgba(212,132,90,0.165)] hover:to-[rgba(212,132,90,0.065)] focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--kaiylo-primary-hex)]/40 focus-visible:ring-offset-0 focus-visible:ring-offset-transparent'
                          : ''
                        }`}
                      role={sessionGlobalComment && sessionGlobalNeedsExpand ? 'button' : undefined}
                    ...
                    >
                      {sessionGlobalComment ? (
                        <>
                          ...
                          {sessionGlobalNeedsExpand && (
                            <span
                              className="absolute bottom-3 right-4 md:bottom-3.5 md:right-4 z-10 inline-flex items-center gap-1 text-sm font-normal pointer-events-none select-none"
                              style={{ color: 'var(--kaiylo-primary-hex)' }}
                              aria-hidden="true"
                            >
                              Voir plus
                    ...
                    {sessionGlobalExpanded && sessionGlobalNeedsExpand && sessionGlobalComment && (
                      <div
                        className="absolute top-0 left-0 w-full z-50 rounded-[10px] p-3 md:p-4 shadow-[0_8px_30px_rgb(0,0,0,0.6)] backdrop-blur-md bg-black/50 bg-gradient-to-br from-[rgba(212,132,90,0.14)] to-[rgba(212,132,90,0.05)] max-h-[350px] overflow-y-auto"
                      >
                        <p className="text-white/90 text-sm font-light leading-relaxed break-words whitespace-pre-wrap pb-7">
                          {sessionGlobalComment}
                        </p>
                        <span
                          className="absolute bottom-3 right-4 md:bottom-3.5 md:right-4 z-10 inline-flex items-center gap-1 text-sm font-normal cursor-pointer select-none hover:opacity-80 transition-opacity"
                          style={{ color: 'var(--kaiylo-primary-hex)' }}
                          onClick={(e) => {
                            e.stopPropagation();
                            setSessionGlobalExpanded(false);
