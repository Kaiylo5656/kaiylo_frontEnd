      ...
      {showUserList && (
        <div className="border-b border-border bg-muted/50">
          <div className="p-2 md:p-3">
            <h3 className="text-xs md:text-sm font-medium text-foreground mb-2">
        ...
        {filteredConversations.length === 0 && !showUserList ? (
          <div className="p-3 md:p-4 text-center text-muted-foreground">
            ...
            <div className="text-xs mt-1">
              {searchTerm ? 'Try a different search term.' : 'Start a new chat to begin messaging.'}
            </div>
          </div>
        ) : (
          ...
          >
            ...
            <div className="flex justify-end space-x-3">
              <button
                onClick={handleDeleteCancel}
                disabled={deleting}
                className="px-4 py-2 text-sm font-medium text-foreground bg-muted border border-border rounded-md hover:bg-muted/80 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-ring disabled:opacity-50"
              >
                Cancel
              </button>
              <button
                ...
                disabled={deleting}
                className="px-4 py-2 text-sm font-medium text-destructive-foreground bg-destructive border border-transparent rounded-md hover:bg-destructive/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-destructive disabled:opacity-50 flex items-center"
              >
                {deleting ? (
                  <>
                    <svg className="animate-spin -ml-1 mr-2 h-4 w-4 text-destructive-foreground" fill="none" viewBox="0 0 24 24">
