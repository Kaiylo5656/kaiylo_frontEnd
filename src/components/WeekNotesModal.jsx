                  ...
                  return (
                    ...
                    >
                      <textarea
                        ...
                        className={`flex-1 px-[14px] py-2.5 rounded-[10px] bg-[rgba(0,0,0,0.5)] border-[0.5px] text-white text-base placeholder:text-[rgba(255,255,255,0.25)] placeholder:font-extralight outline-none focus:outline-none focus:border-[0.5px] transition-colors resize-none min-h-[42px] overflow-hidden ${isFirstDisplayedNote
