...
const SessionExercisesModal = ({ isOpen, onClose, session, position }) => {
  useEffect(() => {
    if (!isOpen) return;
          ...
          return (
            <div
              ...
              className={`
                ...
                border-[0.5px] border-white/20 text-[13px] font-normal
                ${isFirst 
              ...
              <div className="flex flex-col justify-center">
                <p className="leading-normal">
                  {totalSets > 0 && reps > 0 && weight > 0 ? (
                    <>
                      <span className={isFirst ? 'text-white' : 'text-white/50'}>
                        {totalSets}x{reps} reps
                      </span>
                      {' '}
                      <span className={isFirst ? 'text-white' : 'text-[#d4845a]'}>
                        @{weight}kg
                      </span>
                    </>
                  ) : (
