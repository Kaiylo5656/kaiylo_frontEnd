        ...
        {features.map((feature, index) => (
          ...
          >
            ...
            <div className="flex items-center gap-4 relative z-10">
              {feature.title === "Dashboard Coach" ? (
                <div className="w-12 h-12 flex items-center justify-center shrink-0">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" className="w-10 h-10 fill-[#d4845a]">
                ...
                <div className="w-12 h-12 flex items-center justify-center shrink-0">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-10 h-10 fill-[#d4845a]">
            ...
            <div className="mt-auto pt-2 relative z-10">
              <p className="font-['Inter'] font-medium text-sm md:text-[16px] text-[#d4845a] flex gap-2 items-center md:ml-16">
                <span className="shrink-0">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 512" className="w-4 h-4 fill-[#d4845a]">
